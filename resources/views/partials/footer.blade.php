<div class="page-footer purple">
    <div class="container">
        <div class="row">
            <div class="col s12 m6">
                <p class="flow-text">Lorem ipsum dolor sit.</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum nemo aliquam cupiditate assumenda
                    dolore soluta laudantium tenetur suscipit, vel aut?
                </p>
            </div>
